 ...
 */
@FeignClient(value = FeeConstants.APP_NAME, path = FeeIndexFeignService.BASE_PATH)
public interface FeeIndexFeignService {

    String BASE_PATH = FeeConstants.RPC_PATH_V1 + "/smb-fee/index";
